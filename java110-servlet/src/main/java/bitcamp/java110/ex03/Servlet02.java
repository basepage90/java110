...
public class Servlet02 extends GenericServlet {
    ...
    public void service(ServletRequest req, ServletResponse res) throws ServletException, IOException {
        ...
        // => 서블릿 컨테이너는
        //    이 설정에에 따라 출력할 수 있는 출력스트림 객체를 리턴한다.
        //    또한 응답할 때 Content-Type 이라는 응답헤더를 추가한다.
        //
        // => 웹브라우저는 이 설정에 따라 응답헤더의 정보에 따라
        //    웹서버가 보낸 콘텐트를 처리한다.
        ...
        // => Content-Type을 지정하지 않으면기본으로 ISO-8859-1 문자표를 사용한다
        // => Content-Type을 지정하면 응답할 때 응답헤더에 이정보를 추가한다.
        ...
        //    이 MIME 타입을 사용하게 되었다.
        // => 웹브라우저는 서버에서 받은 콘텐트를 어떻게 추력할 것인지
        //    이 MIME 타입을 보고 결정한다.
        //
        // Character-Set
        // => 컴퓨터에서 문자를 저장할때 어떤 코드 값으로 저장할 것인질를 정의한 규칙이다.
        // => 예)
        //      ASCII       - 7비트. 미국 표준
        //      ISO-8859-1(ISO-Latin-1) - 8비트. 국제표준이다.   
        //      EUC-KR      - 16비트. 국제 표준이다. 한글 2350자가 정의되어 있다.
        //      조합형             - 16비트. 아래아한글 규칙.
        //                  초성(5), 중성(5), 종성(5)로 표현.
        //                  3만자 이상의 모든 한글 문자를 표기 할 수 있따.
        //      MS949(CP949) - 16비트. MS OS의 코드표.
        //                  EUC-KR(2350) + 8822 = 11172자
        //      Unicode     - 16비트. 국제 표준이다.
        //                  한글은 1172자가 정의되어 있다.
        //                  영어도 2바이트로 표현된다.
        //      UTF-8       - 1 ~ 4 바이트로문자 표현. 국제표준이다.
        //                  유니코드의 변형이다.
